...
const objects = [
  {
    ...
    detailsOne: 'Buy ticket online',
    detailsTwo: 'Buy ticket online',
    year: '2023',
    image: 'images/new/my-project1.png',
    alt: 'image',
    paragraphShort: 'A daily selection of privately personalized reads; no accounts or sign-ups required.',
    description: "This project is for selling ticket and show the location of concert",
    tools: ['html', 'css', 'Javascript'],
    toolsTwo: ['github', 'ruby', 'bootstraps'],
    submitButton: 'work_section_buttons',
    liveLink: 'bancunguye66.github.io/Festival/',
    sourceLink: '#',
  },
  {
    id: 'card_id_2',
    projectName: 'Todo-list',
    detailsOne: 'Add and remove items',
    detailsTwo: 'Add and remove items',
    year: '2023',
    image: 'images/new/my-project2.png',
    alt: 'image',
    paragraphShort: 'A daily selection of privately personalized reads; no accounts or sign-ups required.',
    description: "This is basic to-do list of creating new tasks, and removing the old task after you successfully completed them.",
    tools: ['html', 'css', 'Javascript'],
    toolsTwo: ['github', 'ruby', 'bootstraps'],
    submitButton: 'work_section_buttons',
    liveLink: 'bancunguye66.github.io/my-Todo-list/',
    sourceLink: '#',
  },
  {
    id: 'card_id_3',
